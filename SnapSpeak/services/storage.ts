...
const ALLOWED_COLUMNS: Record<string, Set<string>> = {
  tasks: new Set(['id', 'title', 'description', 'planned_at', 'due_at', 'reminder_at', 'priority', 'category', 'tags', 'completed', 'completed_at', 'created_at', 'updated_at', 'recurring', 'recurring_end', 'source_type', 'postponed_count', 'current_blocker_reason', 'needs_precheck', 'project_name', 'datetime']),
  captures: new Set(['id', 'task_id', 'type', 'uri', 'text', 'ocr_text', 'transcribed_text', 'created_at']),
  reminders: new Set(['id', 'task_id', 'scheduled_at', 'triggered_at', 'snoozed_until', 'status', 'created_at']),
  ai_actions: new Set(['id', 'task_id', 'action_type', 'status', 'context', 'summary', 'created_at', 'confirmed_at', 'executed_at']),
  memories: new Set(['id', 'task_id', 'type', 'content', 'source', 'created_at']),
  reflections: new Set(['id', 'date', 'type', 'content', 'created_at']),
  blockers: new Set(['id', 'task_id', 'reason', 'recorded_at']),
  conversations: new Set(['id', 'role', 'content', 'type', 'created_at']),
};
